...
namespace PIIPractica01.Data.Helpers
{
    internal class DataHelper
    {
        ...
        private DataHelper()
        {
            _connection = new SqlConnection("Data Source=DESKTOP-IECDJ36\\SQLEXPRESS01;Initial Catalog=Practica01;Integrated Security=True;Trust Server Certificate=True");
        }
